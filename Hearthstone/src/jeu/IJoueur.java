...
public interface IJoueur {
	 ...
	 * en jeu éventuels, aux contrôles, etc.
	 * 
	 * @param carte
	 *            La carte jouée
	 * @throws HearthstoneException
	 ...
	 * Utiliser un serviteur consistera à attaque la cible (un autre serviteur ou le
	 ...
	 * d'être utilisé), il faut gérer le jeu (une carte en moins), ainsi que les
	 * effets liés à la disparition de la carte (Rale d'agonie par exemple).
	 * 
	 * @param carte
